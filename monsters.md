...
Every custom mob on HavenCraft, organized by where you'll meet it. Each entry links to a full page with stats, abilities, and exact drop rates.

## Viking Stronghold

Dungeon 1 — [dungeon guide](/dungeons/viking-stronghold).
...
| [Living Cinder](/monsters/viking-stronghold/living-cinder) | 100 | Invisible flame spirit |
| [Viking Sentinel](/monsters/viking-stronghold/viking-sentinel) | 140 | Elite hallway guardian |
| [Frost Orb](/monsters/viking-stronghold/frost-orb) | 80 | Frost ward — projectiles/fire only |
...
Dungeon 2 — [dungeon guide](/dungeons/castle-nocturn).
...
- [Dungeons](/dungeons)
- [Items](/items)
- [Custom Enchants](/enchants) — many enchants are adapted from these mobs' abilities
