...
The raiders' loot doesn't vanish — it all flows to the Quartermaster. He guards the stronghold's stockroom in full armor, and killing him is like breaking open a supply ship.

**Found in:** [Viking Stronghold](/dungeons/viking-stronghold) — the supply room
...
**Guaranteed supply bundle** (every kill):
...
| Lapis Lazuli | 8–16 |
| Frostbound Tome | 1 |
| Random starter armor piece | 1 (+50% chance of a 2nd) |
| Random starter weapon | 1 |

**Rolls:**

| Drop | Chance |
| --- | --- |
| Experience 200–350 | Always |
...
- [Drunken Raider](/monsters/viking-stronghold/drunken-raider) — his suppliers
